...
test('alle 18 games zijn geregistreerd', () => {
  assert.deepEqual(listGames().map(g => g.key).sort(), ['blackjack','carcassonne','cascadia','civilization','cluedo','hartenjagen','hofslag','kingdomino','minigolf','pesten','presidenten','quoridor','ragnarok','santorini','seven-wonders-duel','solitaire','stratego','ticket-to-ride'].sort());
});
