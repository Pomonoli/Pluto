import { createGameUi } from './js/game-ui.js?v=1.29.0';
import { createScreenWakeLock } from './js/screen-wake-lock.js?v=1.29.0';
...
const screenWakeLock = createScreenWakeLock({ navigator, document, window });
  ...
  if('serviceWorker' in navigator) {
    window.addEventListener('load', async () => {
      try {
        const registration = await navigator.serviceWorker.register('/service-worker.js?v=1.29.0', {
          updateViaCache:'none'
        });
