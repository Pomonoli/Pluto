...
function renderCarcassonne(room,game){
  ...
  const rulesButton=E('button','ghost carc-mobile-rules','Spelregels');rulesButton.type='button';rulesButton.onclick=()=>els.rulesButton?.click();controls.append(rulesButton);
